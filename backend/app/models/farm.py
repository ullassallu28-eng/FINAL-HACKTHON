...
class Farm(Base):
    ...
    risk_level: Mapped[RiskLevel] = mapped_column(pg_enum(RiskLevel), default=RiskLevel.SAFE, index=True, nullable=False)
    ...
    district_id: Mapped[str] = mapped_column(String(64), ForeignKey("districts.id"), index=True, nullable=False)
